...
<div class="page-header d-print-none mb-3 pageBlockItems">
    <div class="row align-items-center">
        <div class="col">
            <h2 class="page-title"><?= __('Új {0} felvitele', __('Page Block Item')) ?></h2>
        </div>
...
<div class="card pageBlockItems">
    <?= $this->Form->create($pageBlockItem) ?>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="tabs-datesheet" role="tabpanel">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <?= $this->Form->control('item_type', ['label' => ['text' => __('Item Type'), 'class' => 'form-label'], 'class' => 'form-control']) ?>
                    </div>
                    <div class="col-md-6">
