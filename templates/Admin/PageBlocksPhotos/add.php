 ...
 * @var \Cake\Collection\CollectionInterface|string[] $pageBlocks
...
<div class="page-header d-print-none mb-3 pageBlocksPhotos">
    <div class="row align-items-center">
        <div class="col">
            <h2 class="page-title"><?= __('Új {0} felvitele', __('Page Blocks Photo')) ?></h2>
        </div>
...
<div class="card pageBlocksPhotos">
    <?= $this->Form->create($pageBlocksPhoto) ?>
    ...
    <div class="card-body pb-4">
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="tabs-datesheet" role="tabpanel">
                <div class="row g-3">
                    <div class="col-md-6">
                        <?= $this->Form->control('page_block_id', [
                            'options' => $pageBlocks,
                            'label' => ['text' => __('Page Block Id'), 'class' => 'form-label'],
                    ...
                    <div class="col-md-6">
                        <?= $this->Form->control('css_class', ['label' => ['text' => __('Css Class'), 'class' => 'form-label'], 'class' => 'form-control']) ?>
                    </div>
