 ...
 * @var \Cake\Collection\CollectionInterface|string[] $heroPhotos
...
<div class="page-header d-print-none mb-3 pages">
    <div class="row align-items-center">
        <div class="col">
            <h2 class="page-title"><?= __('Új {0} felvitele', __('Page')) ?></h2>
        </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <?= $this->Form->control('hero_photo_id', [
                            'options' => $heroPhotos,
                            'label' => ['text' => __('Hero Photo Id'), 'class' => 'form-label'],
                    ...
                    <div class="col-md-6">
                        <?= $this->Form->control('template', ['label' => ['text' => __('Template'), 'class' => 'form-label'], 'class' => 'form-control']) ?>
                    </div>
                    <div class="col-md-6">
                        <?= $this->Form->control('page_blocks_count', [
                            'type' => 'number',
                            'label' => ['text' => __('Page Blocks Count'), 'class' => 'form-label'],
                            'class' => 'form-control',
                            'min' => 0,
                            'max' => 4294967295,
                            'step' => '1',
