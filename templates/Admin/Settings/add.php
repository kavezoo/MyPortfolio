...
<div class="page-header d-print-none mb-3 settings">
    <div class="row align-items-center">
        <div class="col">
            <h2 class="page-title"><?= __('Új {0} felvitele', __('Setting')) ?></h2>
        </div>
...
<div class="card settings">
    ...
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs" data-bs-toggle="tabs" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <?= $this->KvForm->linkTab(__('Value'), '#tabs-value') ?>
            </li>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="tabs-datesheet" role="tabpanel">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <?= $this->Form->control('label', ['label' => ['text' => __('Label'), 'class' => 'form-label'], 'class' => 'form-control', 'required' => true]) ?>
                    </div>
            ...
            <!-- Text tab: value -->
            <div class="tab-pane fade" id="tabs-value" role="tabpanel">
                <div class="row g-3">
                    <div class="col-12">
...
$this->Html->script(['KvAdmin./vendor/hugerte/hugerte.min'], ['block' => 'script']);
?>
